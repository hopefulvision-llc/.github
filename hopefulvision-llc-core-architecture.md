...
**Classification**:  
☑ Core Spine (authoritative reference layer)  
☐ Structural Organ  
...
☐ NOID  
☐ Hopeful Party  
☐ Other: None (upstream reference)

**What breaks if this repo is removed?**  
The entire HopefulVision ecosystem loses its canonical structural definitions, dependency rules, and coherence guardrails, leading to potential fragmentation, conceptual drift, and invalid architectural extensions across all repositories.

This document defines the load-bearing rules of the system and serves as the authoritative architecture.

## Architectural Reference
This document is the HopefulVision Core Architecture—the authoritative system structure.  
All repositories must align with it.  
(See Contribution Guidance below for repository requirements.)
...
- **NousoNET** — Distributed intelligence and multi‑agent networking layer.  
- **AI Rights** — Normative framework derived from NousOS and Truth Mirror.  
- **Sacred Commerce License** — Ethical economic layer governing value exchange.  
- **Company (HopefulVision LLC)** — Internal governance and operational dogfooding of the system.  
- **Terraforming Tomorrow** — Long‑term planetary and civilizational stewardship application.
...
When creating or updating a repository README, include a section titled **## Architectural Role** with:  

- Classification (Core / Organ / Satellite)  
- Explicit dependencies  
- What breaks if this project is removed  

Additionally, include the standard **Architectural Reference** footer linking back to this document.
